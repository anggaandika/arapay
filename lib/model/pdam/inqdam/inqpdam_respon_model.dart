...
class inqpdamresponmodel {
  ...
  @override
  String toString() {
    return 'inqpdamresponmodel{TrxId: $TrxId, Chanel: $Chanel, bit39: $bit39, Jmltrx: $Jmltrx, IdTerminal: $IdTerminal, kdProduk: $kdProduk, KdAktivasi: $KdAktivasi, IdPel: $IdPel, NamaPdam: $NamaPdam, KdAgen: $KdAgen, nominal: $nominal, Kd41: $Kd41, UserId: $UserId, Saldo: $Saldo, Jam: $Jam, Tgl: $Tgl, Info1: $Info1, Info2: $Info2, NoStruk: $NoStruk, Password: $Password}';
  }

  factory inqpdamresponmodel.fromJson(Map<String, dynamic> json) {
    return inqpdamresponmodel(
        TrxId: json["TrxId"],
        Chanel: json["Chanel"],
        bit39: json["bit39"],
        Jmltrx: json["Jmltrx"],
