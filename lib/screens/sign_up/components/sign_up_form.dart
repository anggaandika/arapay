...
class _SignUpFormState extends State<SignUpForm> {
  ...
  TextFormField buildNoHandponeFormField() {
    return TextFormField(
  ...
  Future<dynamic> prosesRegister() async {
    try {
      Service().post2("/cupdam_ara2",
          body: jsonEncode({
            "password": "123",
            "kdaktivasi": "78292iu29",
            "nohp": "0818998777",
            "deviceid": "esghdt1622jjaadd",
            "email": "bembi@yahoo.com",
            "username": "bembi"
          }));
